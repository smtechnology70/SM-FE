export const GAMEDATA = {
  ...
  relationships: [
    ...
    },
    {
      ID: "HOME",
      type: "HOME",
      baseIDs: ["BASE_2", "BASE_4", "BASE_3", "BASE_1"],
    },
    {
      ID: "WALKWAY_2",
      type: "WALKWAY",
  ...
  links: {
    ...
    WEST_1_0: [
      { cellID: "WEST_0_0", position: "WEST" },
      { cellID: "WEST_1_1", position: "WEST" },
    ],
    ...
    NORTH_0_1: [
      { cellID: "NORTH_0_2", position: "NORTH" },
      { cellID: "NORTH_1_1", position: "NORTH" },
    ],
    ...
    EAST_1_5: [
      { cellID: "EAST_2_5", position: "EAST" },
      { cellID: "EAST_1_4", position: "EAST" },
    ],
    ...
    SOUTH_5_1: [
      { cellID: "SOUTH_5_0", position: "SOUTH" },
      { cellID: "SOUTH_4_1", position: "SOUTH" },
    ],
